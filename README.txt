...
The three AI techniques used in WAP include FSM, path finding, and decision making.

The three uses of Mecanim used are player rigged model, penguin eyes, and main menu title.
